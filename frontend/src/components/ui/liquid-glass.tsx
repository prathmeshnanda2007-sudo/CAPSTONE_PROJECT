...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    <div
      className={`relative flex flex-col font-semibold overflow-hidden text-black transition-all duration-700 ${className}`}
      style={glassStyle}
    >
      {/* Glass Layers */}
      <div
      ...
      <div
        ...
        style={{ background: "rgba(255, 255, 255, 0.05)" }} // adjusted from 0.25 to make it look better in dark mode
      />
      <div
...
// SVG Filter Component (Must be rendered once on the page)
